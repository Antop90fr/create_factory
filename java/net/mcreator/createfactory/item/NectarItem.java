...
public class NectarItem extends BucketItem {
	public NectarItem() {
		super(CreateFactoryModFluids.NECTAR, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON)
