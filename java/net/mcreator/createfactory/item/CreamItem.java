...
public class CreamItem extends BucketItem {
	public CreamItem() {
		super(CreateFactoryModFluids.CREAM, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON)
